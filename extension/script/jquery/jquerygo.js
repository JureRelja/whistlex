				...
				for (k = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
					...
					for (
						...
						for (
							...
							(O = g
								? g.apply(e.input ? e.input[0] : null, [
										H
									])
								: [
										!0,
